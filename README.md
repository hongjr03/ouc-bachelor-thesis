...
```bash
typst init @preview/unofficial-ouc-bachelor-thesis:0.3.1
```
<!-- README_INIT_CMD:END -->
...
```typst
#import "@preview/unofficial-ouc-bachelor-thesis:0.3.1": project
...
#show: project.with(
  ...
  defense-date: datetime(year: 2026, month: 5, day: 21),
  abstract: (
    zh: [
